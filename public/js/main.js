...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // ==================== SEARCH TOGGLE ====================
  // Handles search bar toggle for mobile devices
    ...
    window.addEventListener("scroll", function () {
      ...
      if (currentScroll > 50) {
        header.style.boxShadow =
          "0 10px 15px rgba(107, 45, 92, 0.15), 0 4px 6px rgba(107, 45, 92, 0.1)";
      } else {
        header.style.boxShadow =
          "0 4px 6px rgba(107, 45, 92, 0.1), 0 2px 4px rgba(107, 45, 92, 0.06)";
      }
  ...
  console.log(
    "%cBienvenue sur Solea!",
    "color: #6B2D5C; font-size: 20px; font-weight: bold;",
  );
  console.log(
    "%cSite web développé avec passion ✨",
    "color: #C47B9C; font-size: 14px;",
  );
});
