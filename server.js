...
function requireAuth(req, res, next) {
    ...
    if (authHeader) {
        ...
        if (settings && username === settings.admin.username && password === settings.admin.password) {
            return next();
        }
    }
...
app.get('/api/products', (req, res) => {
    ...
    const { category, hairType, special, minPrice, maxPrice, search, sort } = req.query;
    ...
    // Filter by hair type
    if (hairType) {
        products = products.filter(p => p.hairType && p.hairType.includes(hairType));
    }
...
app.put('/api/admin/products/:id', requireAuth, (req, res) => {
    ...
    const updatedProduct = {
        ...
        longDescription: req.body.longDescription !== undefined ? req.body.longDescription : existingProduct.longDescription,
        ...
        hairType: req.body.hairType !== undefined ? req.body.hairType : existingProduct.hairType,
        special: req.body.special !== undefined ? req.body.special : existingProduct.special,
        ...
        variants: req.body.variants !== undefined ? req.body.variants : existingProduct.variants,
        benefits: req.body.benefits !== undefined ? req.body.benefits : existingProduct.benefits,
        ingredients: req.body.ingredients !== undefined ? req.body.ingredients : existingProduct.ingredients,
        certifications: req.body.certifications !== undefined ? req.body.certifications : existingProduct.certifications,
        stock: req.body.stock !== undefined ? parseInt(req.body.stock) : existingProduct.stock,
        visible: req.body.visible !== undefined ? req.body.visible : existingProduct.visible,
        updatedAt: new Date().toISOString()
    };
...
app.delete('/api/admin/products/:id', requireAuth, (req, res) => {
    ...
    res.json({ product: deletedProduct, message: 'Product deleted successfully' });
});
 ...
 */
app.post('/api/admin/products/:id/images', requireAuth, upload.array('images', 5), async (req, res) => {
...
app.post('/api/orders', (req, res) => {
    ...
    res.status(201).json({ order: newOrder, message: 'Order submitted successfully' });
});
...
app.put('/api/admin/settings', requireAuth, (req, res) => {
    ...
    if (req.body.business) {
        settings.business = {
            ...
            freeShippingThreshold: req.body.business.freeShippingThreshold !== undefined 
                ? parseFloat(req.body.business.freeShippingThreshold) 
                : settings.business.freeShippingThreshold,
            shippingCost: req.body.business.shippingCost !== undefined 
